<?php
    ...
    if($_GET['type'] && $_GET['type']!="") {
      ...
      FROM
      trips
      RIGHT JOIN trip_price ON trips.trip_id = trip_price.trip_id WHERE trip_type_id='".$_GET['type']."'";
    ...
    if($_GET['city'] && $_GET['city']!="") {
      if($_GET['activity'] && $_GET['activity']=="") {
        ...
        FROM
        trips
        RIGHT JOIN trip_price ON trips.trip_id = trip_price.trip_id WHERE trip_dest='".$_GET['city']."'";
      } else {
        $sql = "SELECT
        trips.trip_id,
        trips.trip_type_id,
        ...
        FROM
        trips
        RIGHT JOIN trip_price ON trips.trip_id = trip_price.trip_id WHERE trip_dest='".$_GET['city']."' AND trip_activity='".$_GET['activity']."'";
      }
      $searchQuery = mysqli_query($conn,$sql);
    }
                          ...
                          <div class="card bg-info">
                            <div class="card-body">
                              <h5 class="card-category card-category-social">
                                <i class="fa fa-newspaper-o"></i> You trip is saved
                              </h5>
                              <h4 class="card-title">
                                <a href="#pablo">&quot;Next step&quot;</a>
                              </h4>
                              <p class="card-description">
                                Waiting us to check and approve your trip.
                              </p>
                              <div class="card-stats justify-content-center">
                                <a href="myprofile.php" class="btn btn-white btn-round">Go back</a>
                              </div>
                            </div>
                          </div>
                        </div>
                            ...
                            <div class="col-lg-3 col-md-12">
                                ...
                                <div class="col-lg-12 col-md-6">
                                    ...
                                    <div class="card-header card-header-image">
                                        <a href="trip.php?trip_id=<?php echo $result['trip_id'];?>" target="_balnk">
                                    ...
                                    <div class="card-body ">
                                        ...
                                        <h6 class="card-title">
                                        <a href="trip.php"><?php echo cutString($result['trip_name'],55); ?></a>
                                        </h6>
                                        <p class="card-description">
                                    ...
                                    <div class="card-footer ">
                                        <div class="stats">
                                        <i class="material-icons">person</i><span class="text-success"> <?php echo $result['price_unit1']." ";?></span>USD
                                        </div>
                                        <div class="stats ml-auto">
                                        <i class="material-icons">favorite</i> <?php echo rand(1000,10000)?> &#xB7;
                                        </div>
                                    </div>
                                    </div>
                                </div>
